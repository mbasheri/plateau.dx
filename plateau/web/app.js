...
// API base: "" = same-origin (local / all-on-Render); a Render URL when the
// frontend is hosted separately on Vercel. Set in /static/config.js.
const API_BASE = (window.PLATEAU_API_BASE || "").replace(/\/$/, "");
