...
# CORS: needed when the frontend is hosted separately (Vercel) from this API
# (Render). Set CORS_ORIGINS to a comma-separated allowlist in production, e.g.
#   CORS_ORIGINS="https://plateau-dx.vercel.app"
# Defaults to "*" so same-origin/local dev just works.
